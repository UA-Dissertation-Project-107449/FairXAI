...
def cardiac_pipeline(
    ...
    recommendations_task = generate_recommendations.submit(run_id, verbose, wait_for=[profile_task])
    ...
    logger.info(f"  - Recommendations:    {ROOT_DIR}/results/cardiac/recommendations")
