...
class FairnessMetrics:
    ...
    def demographic_parity(
        self, df: pd.DataFrame, sensitive_attr: str, pred_col: str = "y_pred"
    ) -> Dict:
        """
    ...
    def equal_opportunity(
        ...
        for group in df[sensitive_attr].unique():
            ...
            results["group_tpr"][str(group)] = {"tpr": tpr, "true_positive_count": len(positives)}
    ...
    def calibration_by_group(
        ...
        for group in df[sensitive_attr].unique():
            ...
            ece = sum((m["count"] / total_count) * m["calibration_error"] for m in bin_metrics)
    ...
    def calculate_all_metrics(
        ...
        """
        results = {"group_fairness": {}, "calibration": {}, "individual_fairness": {}}
        ...
        if feature_cols and all(col in df.columns for col in feature_cols):
            results["individual_fairness"] = self.individual_fairness_consistency(df, feature_cols)
