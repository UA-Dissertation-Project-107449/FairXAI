...
class CVTrainer:
    ...
    def create_stratified_folds(
        self, X: pd.DataFrame, y: pd.Series, sensitive_attrs: pd.DataFrame
            ...
            for idx in targets_in_fold:
                try:
                    ...
                    row = (
                        ...
                        else X_val.iloc[list(val_indices).index(idx)]
                    )
    ...
    def get_fold_predictions(
        self, model, X: pd.DataFrame, y: pd.Series, sensitive_attrs: pd.DataFrame
    ) -> pd.DataFrame:
        """
